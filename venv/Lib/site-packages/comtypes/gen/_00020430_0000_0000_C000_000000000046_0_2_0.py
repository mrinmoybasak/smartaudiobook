...
IFontDisp = Font
__all__ = [ 'OLE_HANDLE', 'FONTUNDERSCORE', 'LoadPictureConstants',
           'Picture', 'FONTSIZE', 'OLE_XPOS_PIXELS',
           'OLE_ENABLEDEFAULTBOOL', 'Checked', 'OLE_YSIZE_PIXELS',
           'FONTSTRIKETHROUGH', 'StdFont', 'OLE_COLOR',
           'OLE_YSIZE_CONTAINER', 'OLE_YSIZE_HIMETRIC',
           'IFontEventsDisp', 'FONTNAME', 'FONTITALIC', 'FontEvents',
           'Font', 'StdPicture', 'FONTBOLD', 'IPicture',
           'OLE_XSIZE_PIXELS', 'VgaColor', 'IFontDisp',
           'IPictureDisp', 'Default', 'OLE_YPOS_CONTAINER',
           'OLE_TRISTATE', 'OLE_CANCELBOOL', 'IFont',
           'OLE_XSIZE_HIMETRIC', 'Color', 'OLE_XPOS_HIMETRIC',
           'OLE_OPTEXCLUSIVE', 'Gray', 'OLE_XPOS_CONTAINER',
           'OLE_YPOS_PIXELS', 'Monochrome', 'OLE_XSIZE_CONTAINER',
